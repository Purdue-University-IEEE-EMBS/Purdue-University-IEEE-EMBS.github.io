...
<div style="border: 2px solid #ccc; padding: 12px; border-radius: 8px; background-color: #f9f9f9;"> 
    ...
    <ul> 
        ...
        <li> 
            <em>Biomarker Correlation and Severity Analysis:</em> 
            <ul> 
                <li><em> 
        ...
        <li> 
            <em>Data Interpretation and Modeling:</em> 
            <ul> 
                <li><em> 
    ...
    <p> 
        To learn more about the sleep apnea detection project, visit our <a href="{{ site.baseurl }}/docs/current-projects/sleep-apnea-kit/"><strong>project page</strong></a>.
    </p> 
</div>
...
<div style="border: 2px solid #ccc; padding: 12px; border-radius: 8px; background-color: #f9f9f9;"> 
    ...
    <ul> 
        <li> 
            <em>Motor and Tremor Analysis:</em> 
            <ul> 
                <li><em> 
        ...
        <li> 
            <em>Oculomotor and Cognitive Markers:</em> 
            <ul> 
                <li><em> 
        ...
        <li> 
            <em>Multimodal Integration and Classification:</em> 
            <ul> 
                <li><em> 
    ...
    <strong>Learn More About the Project</strong> 
    <p> 
        To learn more about the Tri-Modal Home Kit project, visit our <a href="{{ site.baseurl }}/docs/current-projects/tri-modal-home-kit/"><strong>project page</strong></a>. 
    </p> 
</div>
...
<div style="border: 2px solid #ccc; padding: 12px; border-radius: 8px; background-color: #f9f9f9;">        
    ...
    <ul>
        ...
        <li> 
            <em>Data Modeling and Interpretation:</em> 
            <ul> 
                <li><em> 
        ...
        <li>
            <em>Clinical and Ethical Considerations:</em> 
            <ul> 
                <li><em>
    ...
    <strong>Learn More About the Project</strong> 
    <p> 
        To learn more about the Alzheimer’s retinal and in-ear biosensing project, visit our <a href="{{ site.baseurl }}/docs/current-projects/alzheimers-retinal-hearable/"><strong>project page</strong></a>. 
    </p>
</div>
...
<div style="border: 2px solid #ccc; padding: 12px; border-radius: 8px; background-color: #f9f9f9;">
    ...
    <ul>
        <li>
            <em>Biochemical Signature Mapping:</em>
            <ul>
                <li><em>
        ...
        <li>
            <em>Sampling and Environmental Control:</em>
            <ul>
                <li><em>
    ...
    <strong>Learn More About the Project</strong>
    <p>
        To learn more about the VOC analyzer for lung cancer project, visit our <a href="{{ site.baseurl }}/docs/current-projects/voc-analyzer/"><strong>project page</strong></a>
    </p>
</div>
...
<div style="border: 2px solid #ccc; padding: 12px; border-radius: 8px; background-color: #f9f9f9;"> 
    ...
    <ul> 
        <li> 
            <em>Linguistic and Cultural Context Modeling:</em> 
            <ul> 
                <li><em> 
        ...
        <li> 
            <em>Speech-to-Text and Text-to-Speech Integration:</em> 
            <ul> 
                <li><em> 
        ...
        <li> 
            <em>Medical Communication and Terminology:</em> 
            <ul> 
                <li><em> 
        ...
        <li> 
            <em>AI Ethics and Sociolinguistic Responsibility:</em> 
            <ul> 
                <li><em> 
    ...
    <strong>Learn More About the Project</strong> 
    <p> 
        To learn more about the Multilingual Healthcare Communication App project, visit our <a href="{{ site.baseurl }}/docs/current-projects/multilingual-app/"><strong>project page</strong></a>. 
    </p> 
</div>
